...
const toneByStatus: Record<string, string> = {
  ...
  "out-for-delivery": "bg-indigo-50 text-indigo-800 border border-indigo-200",
  delivered: "bg-emerald-50 text-emerald-800 border border-emerald-200",
  succeeded: "bg-emerald-50 text-emerald-800 border border-emerald-200",
  "partially-refunded": "bg-slate-100 text-slate-700 border border-slate-200",
  ...
  "partially-paid": "bg-amber-50 text-amber-800 border border-amber-200",
  "manual-required": "bg-amber-50 text-amber-900 border border-amber-300",

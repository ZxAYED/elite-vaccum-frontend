  ...
  return (
    <section className="overflow-hidden bg-white py-16 md:py-20">
      <div className="mx-auto max-w-360 px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 rounded-[2rem] bg-[linear-gradient(180deg,#ffffff_0%,#f6fbfa_100%)] px-6 py-8 shadow-[0_30px_70px_-56px_rgba(28,79,80,0.45)] lg:grid-cols-[minmax(0,1fr)_minmax(280px,0.9fr)] lg:px-10 lg:py-10">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <Image
                    ...
                    width={140}
                    height={50}
                    className="h-10 w-auto transition-transform duration-200 hover:-translate-y-0.5"
                  />
                </a>
          ...
          <div className="relative mx-auto w-full max-w-sm">
            <div className="absolute inset-0 rounded-[3rem] bg-teal-100/70 blur-3xl" />
            <Image
              src={mobileImage}

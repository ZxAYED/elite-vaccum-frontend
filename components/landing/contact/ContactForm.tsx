        ...
        <div className="mx-auto max-w-[1440px] px-4">
          <div className="grid gap-12 md:grid-cols-3">
            ...
            <div className="space-y-6">
              <div className="sticky top-20 rounded-[var(--radius-card)] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-sm">
              ...
              <div className="rounded-[var(--radius-card)] bg-primary p-8 text-primary-foreground">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-white/15 pt-6">
                    ...
                    <p className="text-sm text-primary-foreground/90">
                      Photos of the power unit, inlet covers, hose handles, and
                      any visible model labels are the most helpful starting
                      point.
                    </p>
                  </div>
